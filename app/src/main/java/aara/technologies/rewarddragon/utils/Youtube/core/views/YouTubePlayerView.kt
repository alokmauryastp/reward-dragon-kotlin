package aara.technologies.rewarddragon.utils.Youtube.core.views
...
import aara.technologies.rewarddragon.utils.Youtube.core.listeners.YouTubePlayerCallback
...
import aara.technologies.rewarddragon.utils.Youtube.core.utils.FullScreenHelper
import aara.technologies.rewarddragon.utils.Youtube.core.utils.loadOrCueVideo
...
class YouTubePlayerView(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
     ...
     */
    fun addFullScreenListener(fullScreenListener: YouTubePlayerFullScreenListener) =
        fullScreenHelper.addFullScreenListener(fullScreenListener)

    fun removeFullScreenListener(fullScreenListener: YouTubePlayerFullScreenListener) =
