...
class RewardPointsAdapter(private var notifications: List<RewardListModel>, var context: Context) :

    RecyclerView.Adapter<RewardPointsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding!!.point.text = model.earned_point.toString()
        Glide
            .with(context)
