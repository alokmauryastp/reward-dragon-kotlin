...
class WellbeingAverageAdapter(private var notifications: List<TeamWellAverage>, var context: Context) :

    RecyclerView.Adapter<WellbeingAverageAdapter.ViewHolder>() {
